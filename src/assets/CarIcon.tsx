...
export default function CarIcon({ className }: CarIconProps): ReactElement {
  return (
    ...
    >
      ...
      />
      <path d="M10 10L18 10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 12L20 13" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
