...
export default function CarIcon({ className, color = '#059669' }: CarIconProps): ReactElement {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <path d="M10 10L18 10" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 12L20 13" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
